 ...
 */
export type ProblemDocumentProperties = Omit<
  Record<string, unknown>,
  keyof BaseProblemDocumentProperties
> &
  BaseProblemDocumentProperties;
 ...
 */
export class ProblemDocument implements ProblemDocumentProperties {
  detail?: string;
  instance?: string;
  status?: StatusCode;
  title?: string;
